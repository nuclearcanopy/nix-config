{ pkgs, lib, ... }:
{
  ...
  home.file.".claude/CLAUDE.md".text = ''
    ...
    For all other commands (no sudo required), just run them — the Claude Code interface already prompts the user for approval when needed. Do not ask permission before running non-privileged commands.
