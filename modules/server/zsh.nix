{
  # Interactive zsh init: sources mscd.zsh, auto-launches btop on TTY1,
  # exposes nix-commit + a `sync` shortcut for nas mirroring.
  nixos.modules.server-zsh = { pkgs, username, ... }:
